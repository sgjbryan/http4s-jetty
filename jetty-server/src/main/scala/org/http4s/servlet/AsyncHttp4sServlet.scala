...
class AsyncHttp4sServlet2[F[_]] @deprecated("Use AsyncHttp4sServlet.builder", "0.23.13") (
    httpApp: HttpApp[F],
...
object AsyncHttp4sServlet2 {

  class Builder[F[_]] private[AsyncHttp4sServlet2] (
      httpApp: HttpApp[F],
      dispatcher: Dispatcher[F],
    ...
    def build(implicit F: Async[F]): AsyncHttp4sServlet2[F] =
      new AsyncHttp4sServlet2(
        httpApp,
